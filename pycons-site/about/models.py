...
class About(models.Model):
    about_title =  models.CharField(max_length=250, null=False, blank=False, help_text='About PyCon')
    ...
    section_one_title =  models.CharField(max_length=250, null=False, blank=True, default="WHAT IS | PYCON ?", help_text='About PyCon')
    section_one = MarkdownxField(default='', help_text = "[Supports Markdown] - About PyCon .", null=False, blank=False
                             )
    section_two_title =  models.CharField(max_length=250, null=False, blank=True, default="THE | PROGRAM", help_text='About PyCon ')
    section_two = MarkdownxField(default='', help_text = "[Supports Markdown] - About PyCon .", null=False, blank=False
                             )
    section_three_title =  models.CharField(max_length=250, null=False, blank=True, default="THE | TEAM", help_text='About PyCon')
    section_three = MarkdownxField(default='', help_text = "[Supports Markdown] - About PyCon.", null=False, blank=False
                             )
    section_four = MarkdownxField(default='', help_text = "[Supports Markdown] - More about PyCon.", null=False, blank=True
                             )
...
class Venue(models.Model):
    name = models.CharField(max_length=250, null=False, blank=False, help_text='Venue of PyCon')
...
class Travel_Advice(models.Model): 
    title =  models.CharField(max_length=250, null=False, blank=False, help_text='Travel Advice')
    advice = MarkdownxField(default='', help_text = "[Supports Markdown] - Travel Advice", null=False, blank=False
                             )
